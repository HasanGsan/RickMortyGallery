    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.addLoadStateListener { loadState ->  //Состояния New Progress Bar
            when (loadState.source.refresh) {
                is LoadState.Loading -> binding.newProgressBar.visibility = View.VISIBLE
                is LoadState.NotLoading -> binding.newProgressBar.visibility = View.GONE
                is LoadState.Error -> binding.newProgressBar.visibility = View.GONE
            }
        }
